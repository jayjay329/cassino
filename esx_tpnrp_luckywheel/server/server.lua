            ...
            if xPlayer.getMoney() >= amount then
                ...
                SetTimeout(12000, function()
                    ...
                    if _priceIndex == 1 or _priceIndex == 9 or _priceIndex == 13 or _priceIndex == 17 then
                        ...
                        xPlayer.addInventoryItem("scratchoff", 1)
                        xPlayer.addInventoryItem("suppressor", 1)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Rotation: ^1'.. xPlayer.name .. " We have a Winner!")
                    elseif _priceIndex == 2 or _priceIndex == 6 or _priceIndex == 10 or _priceIndex == 14 or _priceIndex == 18 then
                        -- print("banh mi + nuoc")
                        xPlayer.addInventoryItem("tunerchip", 10)
                        xPlayer.addInventoryItem("nitro", 24)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Rotation: ^1'.. xPlayer.name .. " We have a Winner!")
                    elseif _priceIndex == 3 or _priceIndex == 7 or _priceIndex == 15 or _priceIndex == 20 then
                        ...
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Rotation: ^1'.. xPlayer.name .. " Won " .. ESX.Math.GroupDigits(_money) .. "$")
                    elseif _priceIndex == 4 or _priceIndex == 8 or _priceIndex == 11 or _priceIndex == 16 then
                        ...
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Rotation: ^1'.. xPlayer.name .. " Won " .. ESX.Math.GroupDigits(_blackMoney * 10) .. "$")
                    elseif _priceIndex == 5 then
                        -- print("Win 300,000$")
                        xPlayer.addMoney(300000)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Rotation: ^1'.. xPlayer.name .. " Won a $ 300,000 prize!")
                    elseif _priceIndex == 12 then
                        -- print("Win ak gold")
                        xPlayer.addInventoryItem("attach_skin_ak", 1)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Rotation: ^1'.. xPlayer.name .. " won an AR Gold Skin!")
                    elseif _priceIndex == 19 then
                        -- print("Win car lp700r")
                        TriggerClientEvent("esx_tpnrp_luckywheel:winCar", _source)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Rotation: ^1'.. xPlayer.name .. " Won A Brand New Car!")
                    end
                    TriggerClientEvent("esx_tpnrp_luckywheel:rollFinished", -1)
                end)
                TriggerClientEvent("esx_tpnrp_luckywheel:doRoll", -1, _priceIndex)
            else
                TriggerClientEvent('esx:showNotification', _source, "You do not have enough money in your wallet to play! Request " .. ESX.Math.GroupDigits(amount) .. "$ for 1 spin!")
            end
        end
    end
end)
